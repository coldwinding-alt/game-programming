...
public class GameManager : MonoBehaviour
{
    ...
    {
        if (instance != null && score > instance.highScore)
        {
    ...
    public void LevelCleared()
    {
        ...
        {
            FeedbackMessenger.instance.ShowMessage("Sector clear. Mission complete.");
        }
        if (UIManager.instance != null)
        {
            if (player != null)
    ...
    public void GameOver()
    {
        ...
        if (FeedbackMessenger.instance != null)
        {
            FeedbackMessenger.instance.ShowMessage("Ship destroyed. Mission failed.");
        }
