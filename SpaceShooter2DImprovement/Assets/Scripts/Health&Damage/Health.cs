...
public class Health : MonoBehaviour
{
    ...
    public void TakeDamage(int damageAmount)
    {
        ...
        else
        {
            ...
            if (gameObject.CompareTag("Player") && FeedbackMessenger.instance != null)
            {
                FeedbackMessenger.instance.ShowMessage("Hull hit. Lives remaining: " + currentLives);
            }
    ...
    public void ReceiveHealing(int healingAmount)
    {
        ...
        if (gameObject.CompareTag("Player") && FeedbackMessenger.instance != null)
        {
            FeedbackMessenger.instance.ShowMessage("Hull repaired.");
        }
        GameManager.UpdateUIElements();
        CheckDeath();
    }
