...
| `#24` | Stage 3 | Native court, basket, and ball views | Runtime gameplay | Backlog | Gameplay parity checklist |
| `#25` | Stage 4 | Native player view, animation mounts, and spawn anchors | Runtime gameplay | Backlog | Character parity checklist |
...
5. Run `rimrush.EditorTools.rimrushSmokeTest.Run`.
6. Record the result in `TEST_LOG.md` and `DOCS/TEST_LOG.md`.

## Next Cutover

The next default-path cutover target is still Stage 2, but only after the authored menu shell and HUD are manually compared against the golden screenshots in Play Mode and approved for parity.
