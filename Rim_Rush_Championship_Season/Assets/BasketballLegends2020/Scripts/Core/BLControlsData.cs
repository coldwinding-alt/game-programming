...
{
    public readonly struct BLControlProfile
    {
        public BLControlProfile(
            int controllerSlot,
            string moveHint,
            string jumpHint,
            string blockHint,
    ...
    public static class BLControlsData
    {
        private static readonly BLControlProfile soloProfile = new BLControlProfile(
            0,
            "A/D",
            "W",
            "S",
        ...
        private static readonly BLControlProfile playerOneProfile = new BLControlProfile(
            1,
            "A/D",
            "W",
            "S",
        ...
        private static readonly BLControlProfile playerTwoProfile = new BLControlProfile(
            2,
            "LEFT/RIGHT",
            "UP",
            "DOWN",
        ...
        public static BLControlProfile ProfileForBrain(string brain)
        {
            return ProfileForSlot(ParseControllerSlot(brain));
        }

        public static BLControlProfile ProfileForSlot(int controllerSlot)
        {
