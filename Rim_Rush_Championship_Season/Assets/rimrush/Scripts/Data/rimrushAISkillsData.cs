...
namespace rimrush
{
    public readonly struct rimrushAISkillProfile
    {
    ...
    public static class rimrushAISkillsData
    {
        // Skill tuning table used as the current AI difficulty baseline.
        private static readonly rimrushAISkillProfile[] Profiles =
        {
            new rimrushAISkillProfile(
                accuracy: 0.01f,
