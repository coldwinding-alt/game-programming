...
namespace rimrush
{
    public static class rimrushPlayersData
    {
        ...
        {
            new rimrushCharacterDefinition { DisplayName = "REAPER ACOLYTE", SkinIndex = 0, FormIndex = 0, SuperId = 3, Enabled = true, PortraitSpriteName = "custom_head_pumpkin", HeadOffsetX = 1f, HeadOffsetY = -2f, HeadScale = 1f, PreviewScaleMultiplier = 0.99f, PortraitScaleMultiplier = 0.98f, PortraitOffsetY = 3f },
            new rimrushCharacterDefinition { DisplayName = "GHOST CLOWN", SkinIndex = 1, FormIndex = 1, SuperId = 0, Enabled = true, PortraitSpriteName = "custom_head_frankenstein", HeadOffsetX = 1.5f, HeadOffsetY = -2.5f, HeadScale = 0.98f, PreviewScaleMultiplier = 0.97f, PreviewOffsetY = 1f, PortraitScaleMultiplier = 0.95f, PortraitOffsetY = 3f },
            new rimrushCharacterDefinition { DisplayName = "SKULL PIRATE", SkinIndex = 2, FormIndex = 2, SuperId = 1, Enabled = true, PortraitSpriteName = "custom_head_mummy", HeadOffsetX = 2f, HeadOffsetY = -2f, HeadScale = 0.98f, PreviewScaleMultiplier = 0.97f, PreviewOffsetY = 1f, PortraitScaleMultiplier = 0.96f, PortraitOffsetY = 4f },
