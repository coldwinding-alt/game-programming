...
{
    public sealed class BLFixedResolutionPresenter : MonoBehaviour
    {
        private const string CanvasName = "BLFixedResolutionCanvas";
        private const string CameraName = "BLFixedResolutionCamera";
        private const string BackgroundName = "BLFixedResolutionBackground";
        private const string OutputName = "BLFixedResolutionOutput";
        private static BLFixedResolutionPresenter activePresenter;
        ...
        private void EnsureRenderTexture()
        {
            ...
            renderTexture = new RenderTexture(BLConstants.DisplayW, BLConstants.DisplayH, 24, RenderTextureFormat.ARGB32)
            {
                name = "BLFixedResolutionRT",
        ...
        private void RefreshLayout(bool force)
        {
            ...
            var scale = Mathf.Min(
                screenWidth / (float)BLConstants.DisplayW,
                screenHeight / (float)BLConstants.DisplayH);
            var width = Mathf.Round(BLConstants.DisplayW * scale);
            var height = Mathf.Round(BLConstants.DisplayH * scale);
        ...
        private bool TryMapScreenToGamePixelInternal(Vector2 screenPosition, out Vector2 gamePixel)
        {
            ...
            var logicalHeight = BLConstants.GameH / BLConstants.RenderScale;
            gamePixel = new Vector2(
                normalizedX * BLConstants.Width,
